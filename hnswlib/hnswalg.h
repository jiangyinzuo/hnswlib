...
class HierarchicalNSW : public AlgorithmInterface<dist_t> {
 public:
    ...
    mutable std::atomic<uint64_t> distance_calculation_count_{0UL};
    mutable std::atomic<uint64_t> search_knn_count_{0UL};
    ...
    void reset_statistics() {
        this->distance_calculation_count_ = 0UL;
        this->search_knn_count_ = 0UL;
    }

    void print_statistics() const {
        printf("Distance calculations: %lu\n", this->distance_calculation_count_.load());
        printf("Search knn calls: %lu\n", this->search_knn_count_.load());
    }
...
//                    if (candidate_id == 0) continue;
  ...
  searchBaseLayerST(
    ...
    if (bare_bone_search ||
      ...
      this->distance_calculation_count_.fetch_add(1UL);
      lowerBound = dist;
      top_candidates.emplace(dist, ep_id);
...
//                    if (candidate_id == 0) continue;
  ...
  searchKnn(const void *query_data, size_t k,
    ...
    this->search_knn_count_.fetch_add(1UL);
